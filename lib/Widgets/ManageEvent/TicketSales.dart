                        ...
                        children: <Widget>[
                          ...
                          Text(
                            ticketSalesData['total_sold_ticket'] == null
                                ? '-'
                                : ticketSalesData['total_sold_ticket']
                                    .toString(),
                            style: TextStyle(
                          ...
                          GestureDetector(
                            onTap: () {
                              Navigator.of(context).push(MaterialPageRoute(
                                  builder: (context) => BalanceOnHoldDetails(
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          ColumnBuilder(
                            itemCount:
                                ticketData == null ? 0 : ticketData.length,
                                            ...
                                            Container(
                                              child: Row(
                                                ...
                                                children: <Widget>[
                                                  ...
                                                  Text(
                                                    ticketData[i]['paid_ticket_type_id'] ==
                                                                '1' ||
                                                            ticketData[i][
                                                                    'paid_ticket_type_id'] ==
                                                                '3'
