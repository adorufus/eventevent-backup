...
import 'CreateTicketStartTime.dart';

class CreateTicketEndDate extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return CreateTicketEndDateState();
  }
}

class CreateTicketEndDateState extends State<CreateTicketEndDate> {
  ...
  navigateToNextStep() async {
    ...
    if (_selectedDate.day == null || _selectedDate.day.toString() == '') {
      ...
      Navigator.push(
          context, CupertinoPageRoute(builder: (context) => CreateTicketStartTime()));
    }
  }
}