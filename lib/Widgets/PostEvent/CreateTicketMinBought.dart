import 'package:eventevent/Widgets/PostEvent/CreateTicketMaxBought.dart';
...
class CreateTicketMinBought extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return CreateTicketMinBoughtState();
  }
}

class CreateTicketMinBoughtState extends State<CreateTicketMinBought> {
  ...
  navigateToNextStep() async{
    ...
    if (textController.text == null || textController.text == '' || textController.text == ' ') {
      ...
      prefs.setString('SETUP_TICKET_MIN_BOUGHT', textController.text);
      Navigator.push(context,
          CupertinoPageRoute(builder: (BuildContext context) => CreateTicketMaxBought()));
    } else {
      prefs.setString('SETUP_TICKET_MIN_BOUGHT', textController.text);
