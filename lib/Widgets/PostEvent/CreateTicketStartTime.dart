...
import 'CreateTicketEndTime.dart';

class CreateTicketStartTime extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return CreateTicketStartTimeState();
  }
}

class CreateTicketStartTimeState extends State<CreateTicketStartTime> {
  ...
  navigateToNextStep() async {
    ...
    if (_selectedDate.hour == null || _selectedDate.hour.toString() == '' || _selectedDate.minute == null || _selectedDate.minute.toString() == '') {
      ...
      Navigator.push(context, CupertinoPageRoute(builder: (context) => CreateTicketEndTime()));
    }
  }
}