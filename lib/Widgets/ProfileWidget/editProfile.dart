...
class _EditProfileWidgetState extends State<EditProfileWidget>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: userData == null ? Container(child: Center(child: CircularProgressIndicator()),) : buildMainView(),
    );
  }
          ...
          Container(
            ...
            decoration: BoxDecoration(
                ...
                image: DecorationImage(
                    image: pictureUri == null ? AssetImage('assets/white.png') : NetworkImage(pictureUri),
                    fit: BoxFit.contain)),
          ),
          SizedBox(
            height: 30,
  ...
  Future getUserProfileData() async {
    ...
    final userProfileAPI = BaseApi().apiUrl + '/user/detail?X-API-KEY=$API_KEY&userID=$userId';
