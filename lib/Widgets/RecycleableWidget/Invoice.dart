                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        ...
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: <Widget>[
                            Text('${transactionDetail['event']['name']}',
                                style: TextStyle(
                                    color: Colors.black,
                                    fontSize: ScreenUtil.instance.setSp(16))),
                            Text(
                                '${transactionDetail['ticket']['ticket_name']}',
                                style: TextStyle(
                                    color: Colors.black,
                                    fontSize: ScreenUtil.instance.setSp(16))),
                            Text('${transactionDetail['event']['dateStart']}',
                                style: TextStyle(
                                    color: Colors.black,
                                    fontSize: ScreenUtil.instance.setSp(16))),
                            Text(
                                '${transactionDetail['event']['timeStart']} - ${transactionDetail['event']['name']}',
                                style: TextStyle(
                                    color: Colors.black,
                                    fontSize: ScreenUtil.instance.setSp(16))),
                          ],
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        ...
                        Text(
                          transactionDetail['ticket']['paid_ticket_type_id'] ==
                                  '2'
                              ? 'FREE'
                              : transactionDetail['amount'],
                          style: TextStyle(
