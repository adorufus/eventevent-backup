...
class OvoWaitingPayment extends StatefulWidget {
  final String transactionID;
  final String expDate;
  final String paymentImage;

  const OvoWaitingPayment(
      {Key key, this.transactionID, this.expDate, this.paymentImage})
      : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return _OvoWaitingPaymentState();
  }
}

class _OvoWaitingPaymentState extends State<OvoWaitingPayment> {
  String month;
  String hour;
  String min;
  String sec;
