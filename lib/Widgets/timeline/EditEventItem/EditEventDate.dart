...
class EditEventDate extends StatefulWidget {
	...
	State<StatefulWidget> createState() {
		return EditEventDateState();
	}
}

class EditEventDateState extends State<EditEventDate> {
	...
	navigateToNextStep() async {
		...
		if (_selectedDate.day == null || _selectedDate.day.toString() == '') {
			...
			if(_selectedDate == null) {
				...
				Navigator.pop(
					context, _selectedDate.year.toString() + '-' + _selectedDate.month.toString() + '-' + _selectedDate.day.toString());
			}
		}
	}
}